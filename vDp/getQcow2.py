...
apiAccess = {
    ...
    'api': '/5.2.0.0/ML/' + os.environ['szVer'] + '/vdp/vdp-' + os.environ['szVer'] + '.qcow2',
    #'api': '/5.1.2.0/sz_512/' + os.environ['szVer'] + '/vdp/vdp-' + os.environ['szVer'] + '.qcow2',
    'fileName': 'vdp-' + os.environ['szVer'] + '.qcow2'
}
